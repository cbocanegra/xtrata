<%@ Page Language="VB" AutoEventWireup="false" CodeFile="FrmdetalleOrdenCompra.aspx.vb" Inherits="FrmdetalleOrdenCompra" %>
...
<head runat="server">
    <title></title>
     <meta name="Description" content="CASA - Sistema Gestión de Inspectoría" />
...
<body>
    ...
    <table style="left: 46px; width: 655px; position: relative; top: -1px;">
            <tr>
      ...
      <TR><td colspan = 2>
          <asp:GridView ID="gdvOrdenCompra" runat="server" 
           ...
           <td style="text-align: right"></td><td style="text-align: right; color: #000000;">&nbsp;<asp:Label 
                  ID="lblTotal" runat="server" Text="Total :" Visible="False" 
